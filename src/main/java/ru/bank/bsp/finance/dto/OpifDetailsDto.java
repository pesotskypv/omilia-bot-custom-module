...
/**
 * Основная информация по продукту ОПИФ
 */
@Builder
@Data
@AllArgsConstructor
@NoArgsConstructor
public class OpifDetailsDto {
    ...
    private Double totalpiesNumber; // Количество паев
    private Double totalpiePrice; // Стоимость одного пая
    ...
    private Double redemptionSum; // Предварительная сумма к погашению
    private String dateOpening; // дата л/с в реестре ОПИФ
    private String apllNumber; // Номер заявки на приобретение паев
